...
def test_bundle_excludes_runtime_secrets_and_records_exact_sources(tmp_path):
    ...
    for name, data in {
        ...
        "backend/management/.venv/token": "secret",
        "backend/build/key.cpp": "secret",
        "Dockerfile": "obsolete",
    ...
    with tarfile.open(archive) as tar:
        ...
        for suffix in (".env", "rvizweb_configs/private.rvizweb", "Dockerfile", "backend/management/.venv/token"):
